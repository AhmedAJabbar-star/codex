...
export type UiTheme =
  ...
  | 'liquid'     // NEW — Liquid Glass (iridescent vision-style)
...
export const UI_THEMES: { id: UiTheme; label: string; description: string; swatch: string }[] = [
  ...
  { id: 'liquid',   label: '💧 الزجاج السائل — Liquid Glass', description: 'تصميم زجاجي مبتكر بإضاءة قزحية، حواف كروم، وخلفية ميش مضيئة — رؤية حداثية.', swatch: 'linear-gradient(135deg,#a5f3fc,#c4b5fd,#fbcfe8)' },
