...
table.data > tbody.totals-body > tr > td{background:#e2e8f0;font-weight:900;border-top:2px solid #0f4c81;-webkit-print-color-adjust:exact;print-color-adjust:exact;white-space:pre-line;direction:rtl;line-height:1.7}
